...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/offline-mode.client")> &
  InjectionType<typeof import("../../plugins/offline-sync.client")> &
  InjectionType<typeof import("../../plugins/persistent-storage.client")> &
  InjectionType<typeof import("../../plugins/pwa-update-notify.client")> &
  InjectionType<typeof import("../../plugins/session-expiry.client")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:head' | 'nuxt:router' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload-crawler' | 'nuxt:chunk-reload' | 'nuxt:island-link-navigation' | '@nuxt/icon' | 'nuxt:global-components' | 'nuxt:prefetch' | 'vite-pwa:nuxt:pwa-icons-plugin' | 'vite-pwa:nuxt:client:plugin'
  }
}
