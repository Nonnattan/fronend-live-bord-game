...
import { defineComponent, ref, mergeProps, unref, useSSRContext } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrInterpolate } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(GO_LOADING_ICONS, (icon, i) => {
        _push(`<span class="starting__icon" style="${ssrRenderStyle({ animationDelay: `${i * 0.15}s` })}" data-v-b4caee1f>${ssrInterpolate(icon)}</span>`);
      });
...
//# sourceMappingURL=starting-DVfrqKeW.mjs.map
