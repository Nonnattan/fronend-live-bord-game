...
import { B as BottomNav_default } from './BottomNav-jHyGtNKM.mjs';
...
import { u as usePhotoQuest, a as useOfflinePhotoQuestSync } from './usePhotoQuest-CN5VnOPV.mjs';
import { defineComponent, computed, unref, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/index.mjs';
      ...
      if (unref(isReady)) {
        ...
        if (unref(hasPending)) _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) _push2(` Sync (${ssrInterpolate(unref(pendingCount))}) `);
...
//# sourceMappingURL=photo-quest-LJc1xJWG.mjs.map
