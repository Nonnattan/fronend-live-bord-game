...
import { defineComponent, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderClass } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="bottom-nav__label" data-v-a939cb35${_scopeId}>${ssrInterpolate(item.label)}</span>`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([{ "bottom-nav__scan--active": isActive("/scan") }, "bottom-nav__scan"])}" data-v-a939cb35${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "i-lucide-scan-line",
              class: "bottom-nav__scan-icon"
            }, null, _parent2, _scopeId));
            _push2(`</span><span class="bottom-nav__label bottom-nav__label--scan" data-v-a939cb35${_scopeId}>Scan QR</span>`);
...
//# sourceMappingURL=BottomNav-jHyGtNKM.mjs.map
