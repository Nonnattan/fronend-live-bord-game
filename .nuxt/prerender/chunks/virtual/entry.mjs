import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineProdDiagnostics } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/nostics/dist/formatters/ansi.mjs';
import { hasInjectionContext, inject, isRef, toValue, getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, shallowReactive, reactive, effectScope, toRef, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, defineAsyncComponent, mergeProps, defineComponent, withCtx, readonly, computed, shallowRef, h, isVNode, createCommentVNode, resolveComponent, camelize, isReadonly, createElementBlock, cloneVNode, useSSRContext, Suspense, nextTick, Fragment, isShallow, isReactive, toRaw, useModel, renderSlot, openBlock, createBlock, createTextVNode, toDisplayString, mergeModels, watch, Comment, useSlots, queuePostFlushCb, toHandlerKey } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/unctx/dist/index.mjs';
import { createError, sanitizeStatusCode, appendHeader } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/h3/dist/index.mjs';
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/ufo/dist/index.mjs';
import { START_LOCATION, useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue-router/vue-router.node.mjs';
import defu$1, { defu, defuFn } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/defu/dist/defu.mjs';
import { walkResolver } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';
import { $fetch } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { klona } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/klona/dist/index.mjs';
import { hash } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/ohash/dist/index.mjs';
import { Icon, getIcon, loadIcon, _api, addAPIProvider, setCustomIconsLoader, addIcon } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/@iconify/vue/dist/iconify.mjs';
import colors$1 from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/tailwindcss/dist/colors.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderAttrs } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/vue/server-renderer/index.mjs';
import { reactivePick, reactiveOmit, useDebounceFn } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/@vueuse/core/dist/index.js';
import { getIconCSS } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/@iconify/utils/lib/css/icon.js';
import { isEqual, diff } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/ohash/dist/utils/index.mjs';
import { createTV, cnMerge } from 'file://C:/xampp/htdocs/fronend-live-bord-game/node_modules/tailwind-variants/dist/index.js';
...
async function applyPluginsWithDependencies(nuxtApp, plugins) {
  ...
  async function executePlugin(plugin) {
    var _a, _b;
    const unresolvedPluginsForThisPlugin = (_b = (_a = plugin.dependsOn) == null ? void 0 : _a.filter((name) => plugins.some((p) => p._name === name) && !resolvedPlugins.has(name))) != null ? _b : [];
...
var virtual_nuxt__nuxt_2Froutes_default = [
	{
		...
		meta: { layout: "app" },
		component: () => import('../build/_stationId_-DXcUs4Mk.mjs')
	},
	{
		name: "evaluation",
		path: "/evaluation",
		meta: { layout: "app" },
		component: () => import('../build/evaluation-BRgal1qV.mjs')
	},
	{
		name: "history",
		path: "/history",
		meta: { layout: "app" },
		component: () => import('../build/history-BVube4Ev.mjs')
	},
	{
		name: "home",
		path: "/home",
		meta: { layout: "app" },
		component: () => import('../build/home-VgRzosnP.mjs')
	},
	{
		name: "info",
		path: "/info",
		meta: { layout: "app" },
		component: () => import('../build/info-woEb0fxU.mjs')
	},
	{
		name: "map",
		path: "/map",
		meta: { layout: "app" },
		component: () => import('../build/map-hM_GwHrm.mjs')
	},
	{
		name: "offline",
		path: "/offline",
		component: () => import('../build/offline-Y5uLCA5V.mjs')
	},
	{
		name: "photo-quest",
		path: "/photo-quest",
		meta: { layout: "app" },
		component: () => import('../build/photo-quest-LJc1xJWG.mjs'),
		children: [{
			name: "photo-quest-id",
			path: ":id()",
			meta: { layout: "app" },
			component: () => import('../build/_id_-DRxSf1AT.mjs')
		}]
	},
	{
		name: "photo-question-demo",
		path: "/photo-question-demo",
		meta: { layout: "app" },
		component: () => import('../build/photo-question-demo-DPfgkYDz.mjs')
	},
	{
		name: "profile",
		path: "/profile",
		meta: { layout: "app" },
		component: () => import('../build/profile-DsrJP06U.mjs')
	},
	{
		name: "redeem",
		path: "/redeem",
		meta: { layout: false },
		component: () => import('../build/redeem-BIFRb9tb.mjs')
	},
	{
		name: "reservation",
		path: "/reservation",
		meta: { layout: "app" },
		component: () => import('../build/reservation-DwBvuiHC.mjs')
	},
	{
		name: "reward-received",
		path: "/reward-received",
		meta: { layout: false },
		component: () => import('../build/reward-received-DBolMWvB.mjs')
	},
	{
		name: "round-summary",
		path: "/round-summary",
		meta: { layout: false },
		component: () => import('../build/round-summary-BiVCuPlw.mjs')
	},
	{
		name: "scan",
		path: "/scan",
		meta: { layout: "app" },
		component: () => import('../build/scan-K2-lHgDN.mjs')
	},
	{
		name: "starting",
		path: "/starting",
		meta: { layout: "app" },
		component: () => import('../build/starting-DVfrqKeW.mjs')
	},
	{
		name: "station-quest",
		path: "/station-quest",
		meta: { layout: "app" },
		component: () => import('../build/station-quest-uK7h1YzI.mjs')
	},
	{
		name: "stations",
		path: "/stations",
		meta: { layout: "app" },
		component: () => import('../build/stations-CoE-K6EP.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-BHo-uPyE.mjs')
	}
];
//#endregion
...
var virtual_nuxt__nuxt_2Fapp_config_default = /*@__PURE__*/ defuFn(app_config_default, {
	"nuxt": {},
	"ui": {
		"colors": {
			"primary": "green",
...
//#endregion
//#region virtual:nuxt:.nuxt%2Fpwa-icons-plugin.ts
var virtual_nuxt__nuxt_2Fpwa_icons_plugin_default = defineNuxtPlugin(() => {
...
var virtual_nuxt__nuxt_2Fplugins_server_default = [
	...
	virtual_nuxt__nuxt_2Fpwa_icons_plugin_default,
	colors_default,
	plugin
];
//#endregion
...
var _sfc_main$6 = /*@__PURE__*/ Object.assign({ inheritAttrs: false }, {
	__name: "UChip",
	__ssrInlineRender: true,
...
var _sfc_main$5 = /*@__PURE__*/ Object.assign({ inheritAttrs: false }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$6 : unref(Primitive)), mergeProps({ as: as.value.root }, unref(props).chip ? typeof unref(props).chip === "object" ? {
				inset: true,
				...unref(props).chip
			} : { inset: true } : {}, {
				"data-slot": _ctx.$attrs["data-slot"] ?? "root",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(props).src && !error.value) ssrRenderVNode(_push, createVNode(resolveDynamicComponent(as.value.img || unref("img")), mergeProps({
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) ssrRenderSlot(_ctx.$slots, "default", {}, () => {
									if (unref(props).icon) _push(ssrRenderComponent(_sfc_main$7, {
								...
								else return [renderSlot(_ctx.$slots, "default", {}, () => [unref(props).icon ? (openBlock(), createBlock(_sfc_main$7, {
									key: 0,
									name: unref(props).icon,
									"data-slot": "icon",
									class: ui.value.icon({ class: unref(props).ui?.icon })
						...
						default: withCtx(() => [renderSlot(_ctx.$slots, "default", {}, () => [unref(props).icon ? (openBlock(), createBlock(_sfc_main$7, {
							key: 0,
							name: unref(props).icon,
							"data-slot": "icon",
							class: ui.value.icon({ class: unref(props).ui?.icon })
			...
			if (isInternalLink.value) _push(ssrRenderComponent(_component_NuxtLink, mergeProps(unref(nuxtLinkProps), {
				...
				default: withCtx(({ href, navigate, route: linkRoute, isActive, isExactActive, ...rest }, _push, _parent, _scopeId) => {
					if (_push) {
						...
						else _push(ssrRenderComponent(_sfc_main$4, mergeProps({
							..._ctx.$attrs,
							...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
							as: __props.as,
							type: __props.type,
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(_sfc_main$3, mergeProps({
				...
				default: withCtx(({ active, ...slotProps }, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(_sfc_main$4, mergeProps({ "data-slot": "base" }, slotProps, {
						class: ui.value.base({
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
									if (unref(isLeading) && unref(leadingIconName)) _push(ssrRenderComponent(_sfc_main$7, {
								...
								ssrRenderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => {
									if (unref(isTrailing) && unref(trailingIconName)) _push(ssrRenderComponent(_sfc_main$7, {
								...
								renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$7, {
									key: 0,
									name: unref(leadingIconName),
									"data-slot": "leadingIcon",
									class: ui.value.leadingIcon({
								...
								renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$7, {
									key: 0,
									name: unref(trailingIconName),
									"data-slot": "trailingIcon",
									class: ui.value.trailingIcon({
					...
					else return [createVNode(_sfc_main$4, mergeProps({ "data-slot": "base" }, slotProps, {
						class: ui.value.base({
							class: [unref(props).ui?.base, unref(props).class],
							active,
							...active && unref(props).activeVariant ? { variant: unref(props).activeVariant } : {},
...
//#endregion
//#region components/OfflineGateScreen.vue?vue&type=script&setup=true&lang.ts
var OfflineGateScreen_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "OfflineGateScreen",
	__ssrInlineRender: true,
	emits: ["confirm"],
	setup(__props, { emit: __emit }) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "offline-gate" }, _attrs))} data-v-08af5b8e><div class="offline-gate__card" data-v-08af5b8e><div class="offline-gate__icon-wrap" data-v-08af5b8e>`);
			_push(ssrRenderComponent(_component_UIcon, {
				name: "i-lucide-wifi-off",
				class: "offline-gate__icon"
			}, null, _parent));
			_push(`</div><h1 class="offline-gate__title" data-v-08af5b8e>ขณะนี้คุณกำลังใช้งานในโหมด Offline</h1><p class="offline-gate__desc" data-v-08af5b8e> ตรวจไม่พบการเชื่อมต่ออินเทอร์เน็ต ระบบจะเก็บข้อมูลการเล่นทั้งหมดไว้ ในเครื่องของคุณเท่านั้น (LocalStorage) </p><p class="offline-gate__desc" data-v-08af5b8e> ในโหมดนี้จะ<strong data-v-08af5b8e>ยังไม่มีการส่งข้อมูลขึ้นเซิร์ฟเวอร์ และยังไม่มีการ คำนวณคะแนน</strong>ใด ๆ จนกว่าจะกลับมาออนไลน์และเข้าสู่ระบบใหม่อีกครั้ง </p><p class="offline-gate__hint" data-v-08af5b8e> เมื่อกดเข้าสู่โหมด Offline แล้ว จะไม่สามารถสลับกลับเป็นโหมด Online ได้ตลอดการใช้งานครั้งนี้ แม้อินเทอร์เน็ตจะกลับมาระหว่างเล่นก็ตาม </p>`);
			_push(ssrRenderComponent(_component_UButton, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(` เข้าโหมด Offline `);
					else return [createTextVNode(" เข้าโหมด Offline ")];
				}),
				_: 1
			}, _parent));
			_push(`</div></div>`);
...
//#endregion
//#region components/OfflineGateScreen.vue
var _sfc_setup$3 = OfflineGateScreen_vue_vue_type_script_setup_true_lang_default.setup;
OfflineGateScreen_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/OfflineGateScreen.vue");
	return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
var OfflineGateScreen_default = /*#__PURE__*/ Object.assign(_plugin_vue_export_helper_default(OfflineGateScreen_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-08af5b8e"]]), { __name: "OfflineGateScreen" });
//#endregion
...
var virtual_nuxt__nuxt_2Flayouts_default = { app: defineAsyncComponent(() => import('../build/app-CwBo4V2Y.mjs').then((m) => m.default || m)) };
//#endregion
...
//#endregion
//#region node_modules/@vite-pwa/nuxt/dist/runtime/components/VitePwaManifest.js
var VitePwaManifest_default = defineComponent({ async setup() {
	if (pwaInfo) {
		const meta = ref({ link: [] });
		useHead$1(meta);
...
function useOfflineMode() {
	const isOfflineMode = useState("offline-mode-locked", () => false);
	const offlineGatePending = useState("offline-mode-gate-pending", () => false);
	const roundData = useState("offline-mode-round-data", () => null);
	function loadRoundData() {
		roundData.value = readJson();
	}
	/** เรียกครั้งเดียวจาก plugins/offline-mode.client.ts */
	function initConnectivityWatch(onBackOnline) {}
	/** กดปุ่ม "เข้าโหมด Offline" ที่ OfflineGateScreen */
	function confirmOfflineMode() {}
	function persistRoundData(next) {
	...
	function logStationScan(stationId, stationName) {
		const current = roundData.value ?? {
			uid: "",
			stations: []
		};
		...
		persistRoundData({
			...
			stations: [...current.stations, {
				...
				stationName,
				scanTime: Date.now(),
				order: current.stations.length + 1
			}]
		});
	}
	function endRound() {
...
var app_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			const _component_OfflineGateScreen = OfflineGateScreen_default;
			const _component_NuxtLayout = nuxt_layout_default;
			const _component_NuxtPage = page_default;
			const _component_VitePwaManifest = VitePwaManifest_default;
			if (unref(offlineGatePending)) _push(ssrRenderComponent(_component_OfflineGateScreen, mergeProps({ onConfirm: unref(confirmOfflineMode) }, _attrs), null, _parent));
			else {
				_push(`<!--[-->`);
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-DXxSVvUx.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-CR1P3_A_.mjs'));
...
export { $fetch$2 as $, looseToNumber as A, getDisplayValue as B, useForwardProps$1 as C, useEmitAsProps as D, inputIdInjectionKey as E, FieldGroupReset as F, formFieldInjectionKey as G, renderSlotFragments as H, useRuntimeConfig as I, entry as J, NuxtLink as N, Primitive as P, Slot as S, _plugin_vue_export_helper_default as _, useOfflineMode as a, _sfc_main$7 as b, _sfc_main$2 as c, _sfc_main$5 as d, useHead$1 as e, useState as f, useComponentProps as g, useAppConfig as h, useForwardProps as i, useFormField as j, formBusInjectionKey as k, formStateInjectionKey as l, formErrorsInjectionKey as m, navigateTo as n, formInputsInjectionKey as o, formLoadingInjectionKey as p, formOptionsInjectionKey as q, get as r, createContext as s, tv as t, useRoute as u, useFieldGroup as v, useComponentIcons as w, isArrayOfArray as x, compare as y, _sfc_main$6 as z };
