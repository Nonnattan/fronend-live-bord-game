import { a as FocusScope_default, c as useId$1, d as injectConfigProviderContext, f as handleAndDispatchCustomEvent, i as Teleport_default, l as useHideOthers, n as useLocale, o as DismissableLayer_default, p as getActiveElement, r as VisuallyHidden_default, s as Presence_default, t as usePortal, u as useBodyScrollLock } from "./usePortal-CFE28n6Q.js";
import { t as useForwardExpose } from "./useForwardExpose-lTVrimVg.js";
import { A as useForwardProps, C as get, D as _sfc_main$2, E as looseToNumber, N as createContext, O as Primitive, P as useAppConfig, S as compare$1, T as isArrayOfArray, _ as FieldGroupReset, a as _sfc_main$3, b as useForwardProps$1, g as useFormField, j as useEmitAsProps, k as Slot, o as _sfc_main$4, r as _sfc_main$5, s as tv, v as useFieldGroup, w as getDisplayValue, x as useComponentProps, y as useComponentIcons } from "../server.mjs";
import { t as _sfc_main$6 } from "./Input-03a9B_yA.js";
import { Fragment, cloneVNode, computed, createBlock, createCommentVNode, createElementBlock, createTextVNode, createVNode, defineComponent, getCurrentInstance, guardReactiveProps, h, inject, isRef, markRaw, mergeDefaults, mergeModels, mergeProps, nextTick, normalizeProps, normalizeStyle, openBlock, provide, ref, renderList, renderSlot, resolveDynamicComponent, toDisplayString, toRaw, toRef, toRefs, toValue, unref, useModel, useSSRContext, useSlots, useTemplateRef, watch, watchEffect, watchPostEffect, watchSyncEffect, withCtx, withKeys, withMemo, withModifiers } from "vue";
import { defu as defu$1 } from "C:/xampp/htdocs/fronend-live-bord-game/node_modules/defu/dist/defu.mjs";
...
import { createEventHook, createReusableTemplate, reactivePick, unrefElement, useParentElement, useVModel } from "@vueuse/core";
...
//#endregion
//#region virtual:nuxt:.nuxt%2Fui%2Fselect-menu.ts
...
var _sfc_main$1 = /*@__PURE__*/ Object.assign({ inheritAttrs: false }, {
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const contentProps = toRef(() => defu$1(props.content, {
			side: "bottom",
			sideOffset: 8,
			collisionPadding: 8,
			position: "popper"
		...
		const virtualizerProps = toRef(() => {
			...
			return defu$1(typeof props.virtualize === "boolean" ? {} : props.virtualize, { estimateSize: getEstimateSize(filteredItems.value, selectSize.value || "md", props.descriptionKey, !!slots["item-description"]) });
		});
		const searchInputProps = toRef(() => defu$1(props.searchInput, {
		...
		const { isLeading, isTrailing, leadingIconName, trailingIconName } = useComponentIcons(toRef(() => defu$1(props, { trailingIcon: appConfig.ui.icons.chevronDown })));
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(DefineItemTemplate), null, {
				default: withCtx(({ item, index }, _push, _parent, _scopeId) => {
					if (_push) {
						if (isSelectItem(item) && item.type === "label") _push(ssrRenderComponent(unref(ComboboxLabel_default), {
							"data-slot": "label",
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) ssrRenderSlot(_ctx.$slots, "item", {
									...
									ssrRenderSlot(_ctx.$slots, "item-leading", {
										...
										else if (isSelectItem(item) && item.avatar) _push(ssrRenderComponent(_sfc_main$3, mergeProps({ size: item.ui?.itemLeadingAvatarSize || unref(props).ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize() }, item.avatar, {
										...
										if (_push) {
											if (unref(isLeading) || !!unref(props).avatar || !!slots.leading) {
												...
												ssrRenderSlot(_ctx.$slots, "leading", {
													...
													else if (!!unref(props).avatar) _push(ssrRenderComponent(_sfc_main$3, mergeProps({ size: unref(props).ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize() }, unref(props).avatar, {
														"data-slot": "itemLeadingAvatar",
...
//#endregion
//#region virtual:nuxt:.nuxt%2Fui%2Fbadge.ts
...
//#endregion
export { focusFirst as a, VisuallyHiddenInput_default as c, useDirection as d, EVENT_OPTIONS as i, useCollection as l, _sfc_main$1 as n, getFocusIntent as o, ENTRY_FOCUS as r, wrapArray as s, _sfc_main as t, useFormControl as u };

//# sourceMappingURL=Badge--gAvyuw3.js.map