...
import { n as _sfc_main$1, t as _sfc_main } from "./Badge--gAvyuw3.js";
import { D as _sfc_main$2, a as _sfc_main$3, n as _plugin_vue_export_helper_default, r as _sfc_main$4, t as useOfflineMode } from "../server.mjs";
import { t as PageHeader_default } from "./PageHeader-D2G5O0y5.js";
import { t as definePageMeta } from "./pages-Cs7lFyjE.js";
import { c as profileSchema, i as birthYearRangeValueFor, n as GENDER_OPTIONS, s as getAgeRangeOptions, t as useProfile } from "./useProfile-Di4CdYil.js";
...
import { t as _sfc_main$5 } from "./Input-03a9B_yA.js";
import { computed, createTextVNode, createVNode, defineComponent, isRef, mergeProps, ref, unref, useSSRContext, watch, withCtx } from "vue";
...
var profile_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		* server-gas ส่งมาอยู่แล้วทุกครั้ง แค่ไม่เคยถูกนำมาแสดงผลในหน้านี้) */
		...
		computed(() => ONLINE_STATION_TYPES.map((type) => {
		...
		* ในการ์ด + เรียกอัตโนมัติทุกครั้งที่หน้า Profile mount/กลับมา active หลัง Scan) */
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "profile-page" }, _attrs))} data-v-574797bf>`);
			_push(ssrRenderComponent(_component_PageHeader, { title: "โปรไฟล์" }, null, _parent));
			if (!unref(isReady)) {
				_push(`<div class="profile-loading" data-v-574797bf>`);
				_push(ssrRenderComponent(_component_UIcon, {
				...
				_push(`<div class="profile-content" data-v-574797bf><div class="profile-hero" data-v-574797bf>`);
				if (unref(profile)?.pictureUrl) _push(ssrRenderComponent(_component_UAvatar, {
					...
					_push(`<div class="profile-hero__avatar-fallback" data-v-574797bf>`);
					_push(ssrRenderComponent(_component_UIcon, {
				...
				_push(`<h2 class="profile-hero__name" data-v-574797bf>${ssrInterpolate(unref(profile)?.firstName)} ${ssrInterpolate(unref(profile)?.lastName)}</h2>`);
				...
				_push(`</div><div class="stat-row" data-v-574797bf>`);
				if (!unref(isOfflineMode)) _push(`<div class="stat-box" data-v-574797bf><span class="stat-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.point ?? 0)}</span><span class="stat-box__label" data-v-574797bf>คะแนนสะสม</span></div>`);
				else _push(`<!---->`);
				_push(`<div class="stat-box" data-v-574797bf><span class="stat-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.totalVisit ?? 0)}</span><span class="stat-box__label" data-v-574797bf>ครั้งที่ใช้บริการ</span></div></div><div class="info-box" data-v-574797bf><div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>ชื่อ</span><div class="info-box__value-wrap" data-v-574797bf>`);
				if (!unref(isEditingProfile)) _push(`<span class="info-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.firstName)}</span>`);
				...
				if (!unref(isEditingProfile)) {
					_push(`<button type="button" class="info-box__edit-btn" aria-label="แก้ไขข้อมูลโปรไฟล์" data-v-574797bf>`);
					_push(ssrRenderComponent(_component_UIcon, {
				...
				_push(`</div></div><div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>นามสกุล</span><div class="info-box__value-wrap" data-v-574797bf>`);
				if (!unref(isEditingProfile)) _push(`<span class="info-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.lastName)}</span>`);
				else _push(ssrRenderComponent(_component_UInput, {
				...
				_push(`</div></div><div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>เบอร์โทรศัพท์</span><div class="info-box__value-wrap" data-v-574797bf>`);
				if (!unref(isEditingProfile)) _push(`<span class="info-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.phone)}</span>`);
				else _push(ssrRenderComponent(_component_UInput, {
				...
				_push(`</div></div><div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>เพศ</span><div class="info-box__value-wrap" data-v-574797bf>`);
				if (!unref(isEditingProfile)) _push(`<span class="info-box__value" data-v-574797bf>${ssrInterpolate(("GENDER_OPTIONS" in _ctx ? _ctx.GENDER_OPTIONS : unref(GENDER_OPTIONS)).find((g) => g.value === unref(profile)?.gender)?.label ?? "-")}</span>`);
				...
				_push(`</div></div><div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>ช่วงปีเกิด</span><div class="info-box__value-wrap" data-v-574797bf>`);
				if (!unref(isEditingProfile)) _push(`<span class="info-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.birthYearRange || "-")}</span>`);
				else _push(ssrRenderComponent(_component_USelectMenu, {
				...
				_push(`</div></div><div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>เข้าใช้งานด้วย</span><span class="info-box__value" data-v-574797bf>${ssrInterpolate(unref(profile)?.loginType === "line" ? "LINE" : "Guest")}</span></div>`);
				if (unref(profile)?.memberId) _push(`<div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>Member ID</span><code class="info-box__value info-box__value--mono" data-v-574797bf>${ssrInterpolate(unref(profile).memberId)}</code></div>`);
				else _push(`<!---->`);
				if (unref(profile)?.registerDate) _push(`<div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>วันที่สมัคร</span><span class="info-box__value" data-v-574797bf>${ssrInterpolate(new Date(unref(profile).registerDate).toLocaleDateString("th-TH"))}</span></div>`);
				else _push(`<!---->`);
				if (unref(profile)?.lastLogin) _push(`<div class="info-box__row" data-v-574797bf><span class="info-box__label" data-v-574797bf>เข้าใช้งานล่าสุด</span><span class="info-box__value" data-v-574797bf>${ssrInterpolate(new Date(unref(profile).lastLogin).toLocaleString("th-TH"))}</span></div>`);
				else _push(`<!---->`);
				if (unref(editError)) _push(`<p class="info-box__error" data-v-574797bf>${ssrInterpolate(unref(editError))}</p>`);
				else _push(`<!---->`);
				if (unref(isEditingProfile)) {
					_push(`<div class="info-box__actions" data-v-574797bf>`);
				...
				_push(`<button type="button" class="reset-link" data-v-574797bf> รีเซ็ตข้อมูล (ทดสอบ) </button></div>`);
			}
			_push(`</div>`);
		};
	}
...
var profile_default = /*#__PURE__*/ _plugin_vue_export_helper_default(profile_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-574797bf"]]);
//#endregion
export { profile_default as default };

//# sourceMappingURL=profile-DsrJP06U.js.map