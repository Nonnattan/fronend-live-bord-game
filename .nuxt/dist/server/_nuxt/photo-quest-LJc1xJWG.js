...
import { D as _sfc_main, n as _plugin_vue_export_helper_default, r as _sfc_main$1 } from "../server.mjs";
import { t as BottomNav_default } from "./BottomNav-jHyGtNKM.js";
...
import { n as useOfflinePhotoQuestSync, t as usePhotoQuest } from "./usePhotoQuest-CN5VnOPV.js";
import { computed, createTextVNode, defineComponent, mergeProps, toDisplayString, unref, useSSRContext, withCtx } from "vue";
...
var photo_quest_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		*/
		...
		const { quests, completedCount, totalQuests, isLoadingQuests, loadError, usingMockData, initPhotoQuest, isCompleted, canPlayOffline } = usePhotoQuest();
		const { isOnline } = useOfflineSync();
		const { hasPending, pendingCount, isSyncing, syncNow, initOfflinePhotoQuestSync } = useOfflinePhotoQuestSync();
...
//# sourceMappingURL=photo-quest-LJc1xJWG.js.map