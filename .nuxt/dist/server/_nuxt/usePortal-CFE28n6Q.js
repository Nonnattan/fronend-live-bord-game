...
import { C as get, M as renderSlotFragments, N as createContext, O as Primitive } from "../server.mjs";
import * as vue from "vue";
import { Teleport, computed, createBlock, createCommentVNode, defineComponent, getCurrentInstance, h, inject, isRef, nextTick, normalizeStyle, openBlock, reactive, ref, renderSlot, toRef, toRefs, toValue, unref, watch, watchEffect, withCtx } from "vue";
import { defu as defu$1 } from "C:/xampp/htdocs/fronend-live-bord-game/node_modules/defu/dist/defu.mjs";
import { createGlobalState, createSharedComposable, defaultWindow, onKeyStroke, unrefElement, useEventListener, useMounted } from "@vueuse/core";
...
var useBodyLockStackCount = createSharedComposable(() => {
	...
	watch(locked, (val, oldVal) => {
		...
		const config = context.scrollBody?.value ? typeof context.scrollBody.value === "object" ? defu$1({
...
//#endregion
export { FocusScope_default as a, useId$1 as c, injectConfigProviderContext as d, handleAndDispatchCustomEvent as f, Teleport_default as i, useHideOthers as l, useLocale as n, DismissableLayer_default as o, getActiveElement as p, VisuallyHidden_default as r, Presence_default as s, usePortal as t, useBodyScrollLock as u };

//# sourceMappingURL=usePortal-CFE28n6Q.js.map