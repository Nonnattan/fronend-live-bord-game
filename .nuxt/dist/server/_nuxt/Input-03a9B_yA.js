import { D as _sfc_main$1, E as looseToNumber, O as Primitive, P as useAppConfig, a as _sfc_main$2, g as useFormField, s as tv, v as useFieldGroup, x as useComponentProps, y as useComponentIcons } from "../server.mjs";
import { computed, createBlock, createCommentVNode, createVNode, mergeProps, openBlock, renderSlot, unref, useSSRContext, useSlots, useTemplateRef, withCtx } from "vue";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderSlot } from "vue/server-renderer";
import { useVModel } from "@vueuse/core";
//#region virtual:nuxt:.nuxt%2Fui%2Finput.ts
					...
					if (_push) {
						...
						if (unref(isLeading) || !!unref(props).avatar || !!slots.leading) {
							...
							ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
								...
								else if (!!unref(props).avatar) _push(ssrRenderComponent(_sfc_main$2, mergeProps({ size: unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize() }, unref(props).avatar, {
						...
						if (unref(isTrailing) || !!slots.trailing) {
							...
							ssrRenderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => {
								if (unref(trailingIconName)) _push(ssrRenderComponent(_sfc_main$1, {
						...
						}, [renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$1, {
							key: 0,
							name: unref(trailingIconName),
							"data-slot": "trailingIcon",
							class: ui.value.trailingIcon({ class: unref(props).ui?.trailingIcon })
...
//# sourceMappingURL=Input-03a9B_yA.js.map