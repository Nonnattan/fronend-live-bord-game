...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		meta: { layout: "app" },
		component: () => import('../build/_stationId_-h7sDjjEw.mjs')
	},
	{
		name: "evaluation",
		path: "/evaluation",
		meta: { layout: "app" },
		component: () => import('../build/evaluation-B3O9KX7X.mjs')
	},
	{
		name: "history",
		path: "/history",
		meta: { layout: "app" },
		component: () => import('../build/history-D4zNxaoR.mjs')
	},
	{
		name: "home",
		path: "/home",
		meta: { layout: "app" },
		component: () => import('../build/home-BeSedyAH.mjs')
	},
	{
		name: "info",
		path: "/info",
		meta: { layout: "app" },
		component: () => import('../build/info-BartG0di.mjs')
	},
	{
		name: "map",
		path: "/map",
		meta: { layout: "app" },
		component: () => import('../build/map-DeGhOYM1.mjs')
	},
	{
		name: "offline",
		path: "/offline",
		component: () => import('../build/offline-Drg24k4-.mjs')
	},
	{
		name: "photo-quest",
		path: "/photo-quest",
		meta: { layout: "app" },
		component: () => import('../build/photo-quest-aRzInFuX.mjs'),
		children: [{
			name: "photo-quest-id",
			path: ":id()",
			meta: { layout: "app" },
			component: () => import('../build/_id_-Bs2JEOFj.mjs')
		}]
	},
	{
		...
		meta: { layout: "app" },
		component: () => import('../build/photo-question-demo-DrjZSYsk.mjs')
	},
	{
		name: "profile",
		path: "/profile",
		meta: { layout: "app" },
		component: () => import('../build/profile-BdJtCLh7.mjs')
	},
	{
		name: "redeem",
		path: "/redeem",
		meta: { layout: false },
		component: () => import('../build/redeem-DPqWW6T0.mjs')
	},
	{
		name: "reservation",
		path: "/reservation",
		meta: { layout: "app" },
		component: () => import('../build/reservation-BlJxt7-S.mjs')
	},
	{
		name: "reward-received",
		path: "/reward-received",
		meta: { layout: false },
		component: () => import('../build/reward-received-BiQBJE7-.mjs')
	},
	{
		name: "round-summary",
		path: "/round-summary",
		meta: { layout: false },
		component: () => import('../build/round-summary-yUJAdaoE.mjs')
	},
	{
		name: "scan",
		path: "/scan",
		meta: { layout: "app" },
		component: () => import('../build/scan-D84BwqU-.mjs')
	},
	{
		name: "starting",
		path: "/starting",
		meta: { layout: "app" },
		component: () => import('../build/starting-3SIngOdn.mjs')
	},
	{
		name: "station-quest",
		path: "/station-quest",
		meta: { layout: "app" },
		component: () => import('../build/station-quest-Bs5gUivR.mjs')
	},
	{
		name: "stations",
		path: "/stations",
		meta: { layout: "app" },
		component: () => import('../build/stations-BZn5M82R.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-BZYoJN54.mjs')
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { app: defineAsyncComponent(() => import('../build/app-Kp6aEpDT.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-BCI5tkjJ.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-DcyT6543.mjs'));
