							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) ssrRenderSlot(_ctx.$slots, "item", {
									...
									ssrRenderSlot(_ctx.$slots, "item-leading", {
										...
										if (isSelectItem(item) && item.icon) _push(ssrRenderComponent(_sfc_main$7, {
											name: item.icon,
											"data-slot": "itemLeadingIcon",
											class: ui.value.itemLeadingIcon({ class: [unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon] })
										}, null, _parent, _scopeId));
										else if (isSelectItem(item) && item.avatar) _push(ssrRenderComponent(_sfc_main$5, mergeProps({ size: item.ui?.itemLeadingAvatarSize || unref(props).ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize() }, item.avatar, {
											"data-slot": "itemLeadingAvatar",
											class: ui.value.itemLeadingAvatar({ class: [unref(props).ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar] })
										}), null, _parent, _scopeId));
										else if (isSelectItem(item) && item.chip) _push(ssrRenderComponent(_sfc_main$6, mergeProps({
										...
										if (_push) {
											if (unref(isLeading) || !!unref(props).avatar || !!slots.leading) {
												...
												ssrRenderSlot(_ctx.$slots, "leading", {
													...
													else if (!!unref(props).avatar) _push(ssrRenderComponent(_sfc_main$5, mergeProps({ size: unref(props).ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize() }, unref(props).avatar, {
														"data-slot": "itemLeadingAvatar",
											...
											if (unref(isTrailing) || !!slots.trailing || !!unref(props).clear) {
												...
												ssrRenderSlot(_ctx.$slots, "trailing", {
													...
													if (!!unref(props).clear && !isModelValueEmpty(modelValue)) _push(ssrRenderComponent(unref(ComboboxCancel_default), { "as-child": "" }, {
														default: withCtx((_, _push, _parent, _scopeId) => {
															if (_push) _push(ssrRenderComponent(_sfc_main$2, mergeProps({
																as: "span",
													...
													else if (unref(trailingIconName)) _push(ssrRenderComponent(_sfc_main$7, {
											...
											unref(isTrailing) || !!slots.trailing || !!unref(props).clear ? (openBlock(), createBlock("span", {
												...
												default: withCtx(() => [createVNode(_sfc_main$2, mergeProps({
													as: "span",
													icon: unref(props).clearIcon || unref(appConfig).ui.icons.close,
													size: selectSize.value,
													variant: "link",
														...
														default: withCtx((_, _push, _parent, _scopeId) => {
															if (_push) {
																...
																if (!!unref(props).searchInput) _push(ssrRenderComponent(unref(ComboboxInput_default), {
																	...
																	default: withCtx((_, _push, _parent, _scopeId) => {
																		if (_push) _push(ssrRenderComponent(_sfc_main$3, mergeProps({
																			autofocus: "",
																			autocomplete: "off",
																			size: selectSize.value
																...
																!!unref(props).searchInput ? (openBlock(), createBlock(unref(ComboboxInput_default), {
																	...
																	default: withCtx(() => [createVNode(_sfc_main$3, mergeProps({
																		autofocus: "",
																		autocomplete: "off",
																		size: selectSize.value
																	}, searchInputProps.value, {
...
//# sourceMappingURL=Badge-TsOgYTPt.mjs.map
