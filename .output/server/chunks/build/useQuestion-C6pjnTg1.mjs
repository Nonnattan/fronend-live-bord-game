...
var PENDING_KEY = "answerSync:pendingAnswers";
...
function useOfflineAnswerSync() {
	...
	function initOfflineAnswerSync() {
		...
		pendingAnswers.value = readJson(PENDING_KEY, []);
...
export { useOfflineAnswerSync as a, useQuestion as u };
//# sourceMappingURL=useQuestion-C6pjnTg1.mjs.map
