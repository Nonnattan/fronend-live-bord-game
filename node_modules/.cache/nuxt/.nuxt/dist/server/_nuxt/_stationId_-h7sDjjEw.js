import { c as navigateTo, u as useRoute } from "./error-CWdK7u9j.js";
import { t as _sfc_main } from "./Modal-BIBajBOZ.js";
import { D as _sfc_main$1, n as _plugin_vue_export_helper_default, r as _sfc_main$2, t as useOfflineMode } from "../server.mjs";
import { t as useRoundTimer } from "./useRoundTimer-Dx2_uv0V.js";
import { t as PageHeader_default } from "./PageHeader-D2G5O0y5.js";
import { t as definePageMeta } from "./pages-_zuGku1-.js";
import { t as useRequireProfile } from "./useRequireProfile-DlhceP1F.js";
import { i as useAdventure } from "./useAdventure-OrKGgcht.js";
import { t as useRound } from "./useRound-Vyr0MdjD.js";
import { n as useStationMissions, r as useOfflineMissionAnswerSync } from "./useStationMissions-CjHnM2MF.js";
import { n as useStationQuest } from "./useStationQuest-DdT4jEnZ.js";
import { t as useOfflineSync } from "./useOfflineSync-D8-RD8DK.js";
import { Fragment, computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineComponent, isRef, mergeProps, openBlock, readonly, ref, renderList, toDisplayString, unref, useSSRContext, watch, withCtx } from "vue";
...
var _stationId__vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		* ---------------------------------------------------------------------------
		* [แก้ไข] หน้าเต็ม "ภารกิจฐาน___" — เนื้อหา/คะแนนด่านย่อยทั้งหมดมาจาก
		* composables/useStationMissions.ts (เรียก action 'getStationMissions' จริง —
		* ไม่ใช่ 'listStationMissions' ที่เป็น Admin-only) ไม่ hardcode จำนวน/id ฐานหรือ
		* ด่านย่อยใด ๆ (ดู types/mission.ts) สิทธิ์เข้าฐาน (canEnterStation/
		* consumeScanAccess) ยังคงอยู่ที่ composables/useStationQuest.ts เหมือนเดิม
		* ทุกประการ (คนละความรับผิดชอบ — หน้านี้เรียกทั้งสอง Composable คู่กัน)
		*
		* เข้าได้เฉพาะฐานที่ทำด่านย่อยครบแล้ว (ดูซ้ำได้เสมอ) หรือฐานที่เพิ่งได้สิทธิ์จาก
		...
		* เข้าเล่นต่อได้)
		*
		* [แก้ไข] "ฐานสุดท้าย" ไม่ hardcode เป็น id 'milk' อีกต่อไป — ใช้
		* station.isFinal จาก composables/useAdventure.ts แทน (ตัดสินจาก order สูงสุด
		* ในบรรดาฐานที่ active — พลิ้วตามจำนวน/ลำดับฐานจริงจาก Backend) ฐานสุดท้ายแสดง
		* ปุ่มใหญ่ [จบเกม] เสมอไม่ว่าทำด่านย่อยได้กี่ใบก็ตาม ส่วนปุ่ม [เล่นต่อ] โผล่มา
		* "เพิ่ม" เฉพาะตอนทำครบทุกด่านแล้วเท่านั้น
		*/
		...
		const { initOfflineMissionAnswerSync, syncNow: syncMissionAnswersNow } = useOfflineMissionAnswerSync();
...
//# sourceMappingURL=_stationId_-h7sDjjEw.js.map