import { a as useNuxtApp, c as nuxtLinkDefaults, d as docsBase, f as prodReporters, i as defineNuxtPlugin, n as createNuxtApp, o as useRuntimeConfig, r as defineAppConfig, s as asyncDataDefaults, t as applyPlugins, u as appDiagnostics } from "./_nuxt/nuxt-DcOIzELl.js";
...
import { a as useRoute$1, i as sanitizeTag, n as _wrapInTransition, r as isChangingPage, t as _mergeTransitionProps } from "./_nuxt/ready-BxwJ_7--.js";
import { t as useHead$1 } from "./_nuxt/head-Nt-tIetJ.js";
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		meta: { layout: "app" },
		component: () => import("./_nuxt/_stationId_-h7sDjjEw.js")
	},
	{
		name: "evaluation",
		path: "/evaluation",
		meta: { layout: "app" },
		component: () => import("./_nuxt/evaluation-B3O9KX7X.js")
	},
	{
		name: "history",
		path: "/history",
		meta: { layout: "app" },
		component: () => import("./_nuxt/history-D4zNxaoR.js")
	},
	{
		name: "home",
		path: "/home",
		meta: { layout: "app" },
		component: () => import("./_nuxt/home-BeSedyAH.js")
	},
	{
		name: "info",
		path: "/info",
		meta: { layout: "app" },
		component: () => import("./_nuxt/info-BartG0di.js")
	},
	{
		name: "map",
		path: "/map",
		meta: { layout: "app" },
		component: () => import("./_nuxt/map-DeGhOYM1.js")
	},
	{
		name: "offline",
		path: "/offline",
		component: () => import("./_nuxt/offline-Drg24k4-.js")
	},
	{
		name: "photo-quest",
		path: "/photo-quest",
		meta: { layout: "app" },
		component: () => import("./_nuxt/photo-quest-aRzInFuX.js"),
		children: [{
			name: "photo-quest-id",
			path: ":id()",
			meta: { layout: "app" },
			component: () => import("./_nuxt/_id_-Bs2JEOFj.js")
		}]
	},
	{
		...
		meta: { layout: "app" },
		component: () => import("./_nuxt/photo-question-demo-DrjZSYsk.js")
	},
	{
		name: "profile",
		path: "/profile",
		meta: { layout: "app" },
		component: () => import("./_nuxt/profile-BdJtCLh7.js")
	},
	{
		name: "redeem",
		path: "/redeem",
		meta: { layout: false },
		component: () => import("./_nuxt/redeem-DPqWW6T0.js")
	},
	{
		name: "reservation",
		path: "/reservation",
		meta: { layout: "app" },
		component: () => import("./_nuxt/reservation-BlJxt7-S.js")
	},
	{
		name: "reward-received",
		path: "/reward-received",
		meta: { layout: false },
		component: () => import("./_nuxt/reward-received-BiQBJE7-.js")
	},
	{
		name: "round-summary",
		path: "/round-summary",
		meta: { layout: false },
		component: () => import("./_nuxt/round-summary-yUJAdaoE.js")
	},
	{
		name: "scan",
		path: "/scan",
		meta: { layout: "app" },
		component: () => import("./_nuxt/scan-D84BwqU-.js")
	},
	{
		name: "starting",
		path: "/starting",
		meta: { layout: "app" },
		component: () => import("./_nuxt/starting-3SIngOdn.js")
	},
	{
		name: "station-quest",
		path: "/station-quest",
		meta: { layout: "app" },
		component: () => import("./_nuxt/station-quest-Bs5gUivR.js")
	},
	{
		name: "stations",
		path: "/stations",
		meta: { layout: "app" },
		component: () => import("./_nuxt/stations-BZn5M82R.js")
	},
	{
		name: "index",
		path: "/",
		component: () => import("./_nuxt/pages-BZYoJN54.js")
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { app: defineAsyncComponent(() => import("./_nuxt/app-Kp6aEpDT.js").then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BCI5tkjJ.js"));
		const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DcyT6543.js"));
